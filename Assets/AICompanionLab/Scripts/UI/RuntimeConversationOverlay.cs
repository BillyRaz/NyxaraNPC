...
namespace Nyxara.AICompanion.UI
{
    public class RuntimeConversationOverlay : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            var systemsReady = whisperInput != null && whisperInput.WhisperManager != null && companionBrain != null && companionBrain.Agent != null;
            if (!systemsReady)
            {
                _status = GetReadyStatus();
                return;
        ...
        private string GetReadyStatus()
        {
            ...
            {
                return "STT: WhisperManager missing";
            }
            ...
            if (companionBrain.Agent == null)
            {
                return "LLM: agent missing";
            }
