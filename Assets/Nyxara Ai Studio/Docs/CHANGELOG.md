...
- Added integration validation and binding repair in Setup Wizard for already-installed LLMUnity, whisper.unity, and Piper setups
- Added Whisper Setup Wizard source support for manually downloaded `.zip` files in addition to folders, while reusing the existing manual import workflow
